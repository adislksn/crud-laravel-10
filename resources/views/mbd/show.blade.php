                                ...
                                <form action="{{route('mbd.store')}}" method="POST">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="date" class="form-control input-sm" id="fromDate" name="fromDate" value='2022-07-01' required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="date" class="col-form-label col">
                                            ...
                                            <div class="col">
                                                <input type="date" class="form-control input-sm" id="toDate" name="toDate" value='2022-08-01' required>
                                            </div>
                                        </div>
                                        <div class="row">
